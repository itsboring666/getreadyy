...
<section style="background:#0a0a0a; padding: 80px 24px 60px; border-bottom: 1px solid #222;">
    <div style="max-width: 1100px; margin: 0 auto; display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: center;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2px;">
            <img src="{{ asset('assets/images/shopic1.png') }}" onerror="this.src='{{ asset('assets/images/carousel_1.jpg') }}'" alt="Store Exterior" style="width:100%; aspect-ratio:1; object-fit:cover; filter:grayscale(80%);">
            <img src="{{ asset('assets/images/shopic2.png') }}" onerror="this.src='{{ asset('assets/images/carousel_3.jpg') }}'" alt="Store Interior" style="width:100%; aspect-ratio:1; object-fit:cover; filter:grayscale(80%); margin-top: 30px;">
        </div>
    </div>
</section>
