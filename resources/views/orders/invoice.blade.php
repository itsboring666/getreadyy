...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .item-size { font-size: 9px; color: #777; text-transform: uppercase; letter-spacing: 0.5px; margin-top: 2px; }
            ...
            <div class="status-grid">
                <div class="status-item">
                    ...
                    <div class="status-val">
                        @if(strtolower($order->status) === 'paid' || strtolower($order->status) === 'shipped' || strtolower($order->status) === 'delivered')
                            Online Payment
                        @else
