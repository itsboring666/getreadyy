...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'image_2'     => 'nullable|image|mimes:jpg,jpeg,png,webp,avif|max:5120',
            'image_3'     => 'nullable|image|mimes:jpg,jpeg,png,webp,avif|max:5120',
            'image_4'     => 'nullable|image|mimes:jpg,jpeg,png,webp,avif|max:5120',
